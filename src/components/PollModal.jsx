...
const PollModal = ({ open, onClose }) => {
    ...
    const handlePublish = () => {
        if (pollQuestion && pollOptions.every(option => option.trim() !== '')) {
        ...
        console.log('Poll published:', {
            ...
            options: pollOptions,
            duration: hasLimitedDuration ? pollDuration : 'indefinite',
        });
        setPollQuestion('');
        setPollOptions(['', '']);
    ...
    return (
        ...
        >
            ...
            <Button
                ...
                disabled={!pollQuestion || pollOptions.some(option => option.trim() === '')}
