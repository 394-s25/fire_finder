...
const PostCard = () => {
  ...
  const placeholderText =
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed luctus, augue eget scelerisque efficitur. Vivamus nec justo non nunc sodales sollicitudin. Integer id magna nec risus feugiat aliquet.";
  ...
  return (
    <Card
      sx={{ mb: 2, border: "1px solid #ddd", borderRadius: 2, width: "100%" }}
    >
      {/* Profile Section */}
      <CardHeader
        avatar={
      ...
      <CardContent sx={{ pt: 1.5, pb: 1.5, pl: 1.5, pr: 1.5 }}>
        {/* Increased padding for slight length increase */}
